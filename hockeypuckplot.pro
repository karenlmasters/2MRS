...
; NAME:
;       HOCKEYPUCK
; PURPOSE: make Hockey Puck diagrams of redshift surveys (as
; described in Huchra et al. 2011)
;       
; CATEGORY:
; CALLING SEQUENCE:
...
; KEYWORD PARAMETERS:
;       Keywords:
; (this not implemented, but could be...)
...
; whatsoever.  
; If you use this code please cite the description of Hockey Puck
